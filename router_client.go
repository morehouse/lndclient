...
type RouterClient interface {
	...
	// canceling the context provided. Release of intercepted htlcs that
	// have not yet been released by the interceptor is the responsibility
	// of the caller. The handler provided should exit on context cancel,
...
type InterceptedHtlc struct {
	...
	// OutgoingExpiry is the expiry height of the outgoing htlcs.
...
// provided may block, but must exit if the context passed in is canceled. It
// is also responsible for releasing htlcs on exit.
//
