...
require (
	...
	github.com/lightningnetwork/lnd v0.13.0-beta.rc5.0.20210917075117-583ccfeca412
	github.com/lightningnetwork/lnd/kvdb v1.0.2-0.20210917075117-583ccfeca412 // indirect
