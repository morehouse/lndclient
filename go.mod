...
require (
	...
	github.com/juju/mgo/v2 v2.0.0-20220712085729-cbd51d65d65a // indirect
...
// This replace points to a version of lnd that uses the updated lightning-onion
// package that includes route blinding.
